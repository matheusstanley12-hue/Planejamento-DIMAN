    ...
    return `
      ...
      <div class="ws-dashboard fade-in">
         ...
         <div class="ws-chart-card" style="height: auto; margin-bottom: 24px;">
            ...
            <div class="ws-sectors-charts-grid" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(450px, 1fr)); gap: 48px; margin-top: 32px; padding: 16px 0;">
              <div style="height:350px; position:relative; border: 1px solid var(--ws-border); padding: 24px; border-radius: 12px; background: var(--bg-default, #F9FAFB); box-shadow: 0 4px 6px rgba(0,0,0,0.05);"><div style="font-size:15px;font-weight:800;color:var(--text-secondary);margin-bottom:16px;text-align:center;text-transform:uppercase;">Sondas de Pesquisas</div><canvas id="wsChart_Sondas_de_Pesquisas"></canvas></div>
              <div style="height:350px; position:relative; border: 1px solid var(--ws-border); padding: 24px; border-radius: 12px; background: var(--bg-default, #F9FAFB); box-shadow: 0 4px 6px rgba(0,0,0,0.05);"><div style="font-size:15px;font-weight:800;color:var(--text-secondary);margin-bottom:16px;text-align:center;text-transform:uppercase;">Sondas Poços</div><canvas id="wsChart_Sondas_Pocos"></canvas></div>
              <div style="height:350px; position:relative; border: 1px solid var(--ws-border); padding: 24px; border-radius: 12px; background: var(--bg-default, #F9FAFB); box-shadow: 0 4px 6px rgba(0,0,0,0.05);"><div style="font-size:15px;font-weight:800;color:var(--text-secondary);margin-bottom:16px;text-align:center;text-transform:uppercase;">Bombas de poços</div><canvas id="wsChart_Bombas_de_pocos"></canvas></div>
              <div style="height:350px; position:relative; border: 1px solid var(--ws-border); padding: 24px; border-radius: 12px; background: var(--bg-default, #F9FAFB); box-shadow: 0 4px 6px rgba(0,0,0,0.05);"><div style="font-size:15px;font-weight:800;color:var(--text-secondary);margin-bottom:16px;text-align:center;text-transform:uppercase;">Bomba de pesquisa</div><canvas id="wsChart_Bomba_de_pesquisa"></canvas></div>
              <div style="height:350px; position:relative; border: 1px solid var(--ws-border); padding: 24px; border-radius: 12px; background: var(--bg-default, #F9FAFB); box-shadow: 0 4px 6px rgba(0,0,0,0.05);"><div style="font-size:15px;font-weight:800;color:var(--text-secondary);margin-bottom:16px;text-align:center;text-transform:uppercase;">Subconjuntos</div><canvas id="wsChart_Subconjuntos"></canvas></div>
              <div style="height:350px; position:relative; border: 1px solid var(--ws-border); padding: 24px; border-radius: 12px; background: var(--bg-default, #F9FAFB); box-shadow: 0 4px 6px rgba(0,0,0,0.05);"><div style="font-size:15px;font-weight:800;color:var(--text-secondary);margin-bottom:16px;text-align:center;text-transform:uppercase;">Programação de almoxarifado</div><canvas id="wsChart_Programacao_de_almoxarifado"></canvas></div>
              <div style="height:350px; position:relative; border: 1px solid var(--ws-border); padding: 24px; border-radius: 12px; background: var(--bg-default, #F9FAFB); box-shadow: 0 4px 6px rgba(0,0,0,0.05);"><div style="font-size:15px;font-weight:800;color:var(--text-secondary);margin-bottom:16px;text-align:center;text-transform:uppercase;">Outros</div><canvas id="wsChart_Outros"></canvas></div>
            </div>
         </div>
